...
?>
<form action="event_service_details_update.php" id="formID" method="post" name="form1">
<input type="hidden" name="services_id" value="<?php echo $row['services_id'];?>">
  <table width="413" border="0" align="center">
    ...
    <tr>
      ...
      <td><input name="service_catagory_id" type="text" class=" form-control validate[required,custom[onlyNumber]]" value="<?php echo $row['service_catagory_id'];?>"></td>
    </tr>
    <tr>
