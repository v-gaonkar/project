...
<?php
 include('../dbconnect/dbconnection.php');
  ...
  <tr>
    ...
    <td><img src="../images/<?php echo $row['hall_photos'];?>width="100" height="200"></td>
    <td><?php echo $row['hall_discription'];?></td>
    <td><?php echo $row['perday_cost'];?></td>
    <td><?php echo $row['types_of_hall'];?></td>
    <td><a href="hall_detail_edit.php?hall_id=<?php echo $row['hall_id'];?>">Edit</a></td>
    <td><a href="hall_detail_delete.php?hall_id=<?php echo $row['hall_id'];?>">Delete</a></td>
  </tr>
  <?php
  }
  ?>
