...
<form name="form1" method="post" id="formID" action="user_bill_details_insert.php">
  <table width="373" border="0" align="center">
    ...
    <tr>
	  ...
	  {
	  ?>
	  <option value="<?php echo $row['service_booking_id']?>">
    ...
    <tr>
      ...
      <td width="178">
        <div align="left">
          <input name="bill_amount" type="text" id="bill_amount" class=" form-control validate[required,custom[onlyNumber]]"></div></td>
    </tr>
    <tr>
