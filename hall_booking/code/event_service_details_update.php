...
$sql="update event_service_details set services_name='$service_name',services_discription='$services_discription',service_price='$service_price',services_photo='$services_photo',service_catagory_id='$service_catagory_id' where services_id='$services_id'";
