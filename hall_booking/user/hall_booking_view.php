...
<?php include('sidebar.php');?>
 ...
 <?php  
  ...
  $sql="select * from hall_booking hb,hall_details hd,user_details ud where hb.hall_id=hd.hall_id and hb.user_id=ud.user_id and ud.email_id='$uname'" ;
  ...
  ?>
   <td><?php echo $sl_no++ ; ?></td>
    ...
    <td><?php if($row['booking_status']=='Confirmed'){ ?> <a href="pay_now.php?user_id=<?php echo $row['user_id'];?>&hall_booking_id=<?php echo $row['hall_booking_id'];?>&hall_name=<?php echo $row['hall_name'];?>&perday_cost=<?php echo $row['perday_cost'];?>" class="btn btn-primary">Pay Now</a> <?php } ?>
	<?php if($row['booking_status']=='Pending'){ ?> <a href="hall_booking_delete.php?hall_booking_id=<?php echo $row['hall_booking_id'];?>" class="btn btn-danger">Cancle</a> <?php } ?></td>
	</tr>
  <?php
  }
  ?>
