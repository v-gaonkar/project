...
$sql="update service_catagory_details set service_catagory_name='$service_catagory_name',service_photo='$service_photo' where service_catagory_id ='$service_catagory_id'";
