      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
			 <?php include('cal.php'); ?>
						  <form name="form1" method="post" role="form" action="confirm_service_booking_details_view.php" id="formID">
...
<b>From Date : <font color="#0000FF"><?php echo $date1; ?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To Date : <font color="#0000FF"><?php echo $date2; ?></font>&nbsp;</b>
  ...
  $tot=0;
  $sql="select * from service_booking_details sd,event_service_details es,user_details ud where sd.service_id=es.services_id and sd.user_id=ud.user_id and sd.booking_status='Confirmed' and sd.book_date between '$date1' and '$date2'";
