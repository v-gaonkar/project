...
<?php include('sidebar.php');?>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
			 <?php include('cal.php'); ?>
						  <form name="form1" method="post" role="form" action="date_confirm_service_booking_details_view.php" id="formID">
  ...
  $tot=0;
  $sql="select * from service_booking_details sd,event_service_details es,user_details ud where sd.service_id=es.services_id and sd.user_id=ud.user_id and sd.booking_status='Confirmed' ";
