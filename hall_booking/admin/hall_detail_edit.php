...
<form action="hall_details_update.php" id="formID" method="post" name="form1">
 <input type="hidden" name="hall_id" value="<?php echo $row['hall_id'];?>">
  <table width="531" border="0" align="center">
    <tr>
      <td width="181"><div align="center">Hall name </div></td>
    ...
    <tr>
      ...
      <td><div align="center">
        <textarea name="hall_address" class=" form-control validate[required]" id="hall_address"><?php echo $row['hall_address'];?></textarea>
      </div></td>
    </tr>
    <tr>
      <td><div align="center">Owner name</div></td>
      <td><div align="center">
        <input name="owner_name" type="text" id="owner_name" class=" form-control validate[required]" value="<?php echo $row['owner_name'];?>">
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><div align="center">
        <textarea name="hall_discription" class=" form-control validate[required]" id="hall_discription"><?php echo $row['hall_discription'];?></textarea>
      </div></td>
    </tr>
    <tr>
